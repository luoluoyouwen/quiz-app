...
export const CHANGELOG: VersionEntry[] = [
  ...
  },
  {
    version: '1.5.0',
    date: '2026-06-23',
    title: '体验优化：背题答案展开 / AI规范化修复 / 首页布局',
    changes: [
      '背题模式选择/多选题显示完整答案内容，不再只显示选项字母',
      '修复 AI 规范化将答案标记移至题头导致题干挖空丢失的问题',
      '修复深色模式下题目列表表头反色异常',
      '修复空状态提示文字过长且版本号/帮助排版',
      '首页题库卡片统计改为网格布局，题目数和上次练习均衡对齐',
      '离开练习页面时自动记录练习时间（提交过至少一题即记）',
      '新增「使用帮助」弹窗，引导新手快速上手',
      '开屏显示「启动引擎中...」加载提示，替代白屏等待',
    ],
  },
  {
    version: '1.4.0',
