...
AI 归一化双模式详情见[第 14 章](#14-ai-格式整理模块)。
...
### 14.3 实现架构 (`src/utils/parsers/normalize.ts`)
...
### 14.5 CF Pages Function (`functions/api/ai-normalize.ts`)
